...
class NewCardTabletUi extends StatelessWidget {
  const NewCardTabletUi({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final deviceWidth = MediaQuery.of(context).size.width;
    final deviceHeight = MediaQuery.of(context).size.height;
    final controller = Modular.get<NewCardController>();
                ...
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'registerNewBoardOrCard.writeCardNameHint'.tr(),
